...
// Note: this file intentionally does NOT redefine the base shadcn `Button`/
// `buttonVariants` (see src/components/ui/button.tsx for that) — only the
// liquid-glass and metal variants that are unique to this component.
